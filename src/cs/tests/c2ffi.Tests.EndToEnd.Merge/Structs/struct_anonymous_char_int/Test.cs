...
namespace c2ffi.Tests.EndToEnd.Merge.Structs.struct_anonymous_char_int;
...
public class Test : MergeFfisTest
{
    ...
    private void StructExists(CTestFfiCrossPlatform ffi)
    {
        ...
        _ = fieldType.Name.Should().NotBeNull();

...
/// <summary>
///     Represents the computer architecture and operating system of a target platform.
/// </summary>
[PublicAPI]
...
public record struct TargetPlatform(string ClangTargetTriple)
{
    ...
    /// </summary>
    public NativeArchitecture Architecture = ParseTargetArchitecture(ClangTargetTriple);
